...
<body>
	...
	<div style="background: #CCCCCC; font-size: 40px;">
		<s:label name="AssignSuccess" value="Project Assignment Successful"></s:label>
	</div>
	<br />
	<div style="background: #CCCCCC; font-size: 25px;">
		<s:label name="Details" value="Details :"></s:label>
		<br />
		...
		<br />
		<s:label name="Emp" value="The following employees are assigned : "></s:label>
		<br />
